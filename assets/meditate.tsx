...
import Svg, { Path, Polygon, Circle, Ellipse, Polyline, SvgProps } from 'react-native-svg';
const Meditate = (props: SvgProps) => (
  <Svg
    width={100}
    height={100}
    ...
    <Path d="m485.69,231.49s34-12,47,27c13,39,10,71,10,71l-50,16-7-114h0Z" fill="#6c63ff" />
    <Path
      d="m252.54,475.25l-10.91-19.22,23.57-58.67,11.08-75.53,45.95,15.32-7.81,77.2c-.8,7.89-4.81,15.25-11,20.2l-50.88,40.71h0Z"
      fill="#a0616a"
    />
    <Path d="m330.69,231.49s-34-12-47,27c-13,39-10,71-10,71l50,16,7-114h0Z" fill="#6c63ff" />
