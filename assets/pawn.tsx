...
const Pawn = (props: SvgProps) => (
  <Svg
    ...
    <G id="SVGRepo_iconCarrier">
      ...
      />
      <Path
        d="M32.42 106.89c-.83.93-.8 2.86 1.65 4.47c2.62 1.72 6.84 4.17 12.89 5.3c6.16 1.15 12.58.8 12.18-1.26c-.27-1.41-5.61.17-15.08-3.58c-5.56-2.2-7.28-3.41-8.41-4.21c-.73-.53-2.03-2.06-3.23-.72z"
        fill="#b0b0af"
      />
      <Path d="M39.59 96.28c1.93 0 1.93-3 0-3s-1.93 3 0 3z" fill="#b0b0af" />
    </G>
  </Svg>
);
export default Pawn;
