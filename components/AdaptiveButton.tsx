...
const AdaptiveButton: React.FC<AdaptiveButtonProps> = ({
  ...
  const getButtonStyles = () => {
    ...
    const currentVariantStyles = disabled ? disabledStyles[variant] : variantStyles[variant];
  ...
  const getTextStyles = () => {
    ...
    const currentTextStyles = disabled ? disabledTextStyles[variant] : variantStyles[variant];
